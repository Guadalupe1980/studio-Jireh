        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <article className="mx-auto w-full max-w-sm overflow-hidden rounded-xl border border-rose-100 bg-white shadow-md transition duration-300 hover:-translate-y-2 hover:shadow-xl">
            <div className="h-56 overflow-hidden bg-rose-50">
              <img
                src= "https://imgs.search.brave.com/FGFjhesTwIZ-GUiFemJcG8YzJR0FG8JYAr5_MZ0oN2k/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9sYXNo/ZXNhbmRnby5jb20v/d29yZHByZXNzL3dw/LWNvbnRlbnQvdXBs/b2Fkcy8yMDIzLzAy/L2V4dGVuc2lvbmVz/LXBlc3RhbmFzLTZE/LmpwZw"
            ...
            <div className="p-5">
              ...
              <p className="mt-3 text-xs italic leading-6 text-stone-500">
                Extensiones de pestañas que aportan volumen y una mirada más
                definida.
              </p>
