        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <article className="mx-auto w-full max-w-sm overflow-hidden rounded-xl border border-rose-100 bg-white shadow-md transition duration-300 hover:-translate-y-2 hover:shadow-xl">
            <div className="h-56 overflow-hidden bg-rose-50">
              <img
                src="https://imgs.search.brave.com/VHokz077JP_5x1lsBGjEHw-Y0vzLfU1N86ofneGTZ4c/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9zdDUu/ZGVwb3NpdHBob3Rv/cy5jb20vMzU4NDA1/My82OTY4Ni9pLzQ1/MC9kZXBvc2l0cGhv/dG9zXzY5Njg2MjE5/NC1zdG9jay1waG90/by1tYWtldXAtYXJ0/aXN0LWFwcGxpZXMt/cmVkLWxpcHN0aWNr/LmpwZw"
                alt="Maquillaje de noche para dama"
            ...
            <div className="p-5">
              ...
              <p className="mt-3 text-xs italic leading-6 text-stone-500">
                Maquillaje intenso y elegante, ideal para eventos y ocasiones
                especiales.
              </p>
